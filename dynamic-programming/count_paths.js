...
const countPaths = (grid, r=0, c=0) => {
    ...
    const down = countPaths(grid, r+1, c);
    const up = countPaths(grid, r, c+1);
    return down + up;
};

const countPaths2 = (grid, r=0, c=0, memo={}) => {
    // need to insert position into memo object as string, not number
    const pos = `${r}, ${c}`;
